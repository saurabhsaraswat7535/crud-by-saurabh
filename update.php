...
$sql="update tblusers set Name=:fn,Pincode=:ln,EmailId=:eml,ContactNumber=:cno,Dob=:adrss where id=:uid";
...
<div class="row">
<div class="col-md-12">
<h3>Update Record | saurabh saraswat crud</h3>
<hr />
</div>
</div>
...
// Get the userid
$userid=intval($_GET['id']);
$sql = "SELECT Name,Pincode,EmailId,ContactNumber,Dob,PostingDate,id from tblusers where id=:uid";
//Prepare the query:
$query = $dbh->prepare($sql);
//Bind the parameters
$query->bindParam(':uid',$userid,PDO::PARAM_STR);
...
<input type="text" name="lastname" value="<?php echo htmlentities($result->Pincode);?>" class="form-control" required>
</div>
</div>
...
<textarea class="form-control" name="address" required><?php echo htmlentities($result->Dob);?></textarea>
</div>
</div>  
<?php }} ?>
